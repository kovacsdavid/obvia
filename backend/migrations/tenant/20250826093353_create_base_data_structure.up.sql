...
insert into currencies (code, number, name)
values ('HUF', 348, 'Forint'),
       ('AED', 784, 'UAE Dirham'),
       ('AFN', 971, 'Afgán'),
       ('ALL', 8, 'Lek'),
       ('AMD', 51, 'Örmény Dram'),
       ('ANG', 532, 'Holland Antillák Gulden'),
       ('AOA', 973, 'Kwanza'),
       ('ARS', 32, 'Argentin Peso'),
       ('AUD', 36, 'Ausztrál Dollár'),
       ('AWG', 533, 'Arubai Florin'),
       ('AZN', 944, 'Azerbajdzsáni Manat'),
       ('BAM', 977, 'Konvertibilis Márka'),
       ('BBD', 52, 'Barbados Dollár'),
       ('BDT', 50, 'Taka'),
       ('BGN', 975, 'Bolgár Lev'),
       ('BHD', 48, 'Bahreini Dinár'),
       ('BIF', 108, 'Burundi Frank'),
       ('BMD', 60, 'Bermudai Dollár'),
       ('BND', 96, 'Brunei Dollár'),
       ('BOB', 68, 'Boliviano'),
       ('BOV', 984, 'Mvdol'),
       ('BRL', 986, 'Brazil Real'),
       ('BSD', 44, 'Bahama Dollár'),
       ('BTN', 64, 'Ngultrum'),
       ('BWP', 72, 'Pula'),
       ('BYR', 974, 'Fehérorosz Rubel'),
       ('BZD', 84, 'Belize Dollár'),
       ('CAD', 124, 'Kanada Dollár'),
       ('CDF', 976, 'Kongói Frank'),
       ('CHE', 947, 'WIR Euro'),
       ('CHF', 756, 'Svájci Frank'),
       ('CHW', 948, 'WIR Frank'),
       ('CLF', 990, 'Unidad de Fomento'),
       ('CLP', 152, 'Chilei Peso'),
       ('CNY', 156, 'Yuan Renminbi'),
       ('COP', 170, 'Kolumbiai Peso'),
       ...
       ('CZK', 203, 'Cseh Korona'),
       ('DJF', 262, 'Djibouti Frank'),
       ('DKK', 208, 'Dán Korona'),
       ('DOP', 214, 'Dominikai Peso'),
       ('DZD', 12, 'Algériai Dinár'),
       ('EGP', 818, 'Egyptomi Font'),
       ('ERN', 232, 'Nakfa'),
       ('ETB', 230, 'Etióp Birr'),
       ('EUR', 978, 'Euro'),
       ('FJD', 242, 'Fiji Dollár'),
       ('FKP', 238, 'Falkland Szigeteki Font'),
       ('GBP', 826, 'Sterling Font'),
       ('GEL', 981, 'Lari'),
       ('GHS', 936, 'Ghána Cedi'),
       ('GIP', 292, 'Gibraltár Font'),
       ('GMD', 270, 'Dalasi'),
       ('GNF', 324, 'Guinea Frank'),
       ('GTQ', 320, 'Quetzal'),
       ('GYD', 328, 'Guyana Dollár'),
       ('HKD', 344, 'Hong Kong Dollár'),
       ('HNL', 340, 'Lempira'),
       ('HRK', 191, 'Kuna'),
       ('HTG', 332, 'Gourde'),
       ('IDR', 360, 'Rúpia'),
       ('ILS', 376, 'Új izraeli Sheqel'),
       ('INR', 356, 'Indiai Rúpia'),
       ('IQD', 368, 'Iraki Dínar'),
       ('IRR', 364, 'Iráni Rial'),
       ('ISK', 352, 'Izlandi Korona'),
       ('JMD', 388, 'Jamaikai Dollár'),
       ('JOD', 400, 'Jordán Dinár'),
       ('JPY', 392, 'Yen'),
       ('KES', 404, 'Kenyai Shilling'),
       ('KGS', 417, 'Som'),
       ('KHR', 116, 'Riel'),
       ('KMF', 174, 'Comoro-frank'),
       ('KPW', 408, 'Észak-koreai Won'),
       ('KRW', 410, 'Won'),
       ('KWD', 414, 'Kuwaiti Dinár'),
       ('KYD', 136, 'Kajmán-szigeteki Dollár'),
       ('KZT', 398, 'Tenge'),
       ('LAK', 418, 'Kip'),
       ('LBP', 422, 'Libanoni Font'),
       ('LKR', 144, 'Sri Lankai Rúpia'),
       ('LRD', 430, 'Libériai Dollár'),
       ('LSL', 426, 'Loti'),
       ('LYD', 434, 'Líbiai Dinár'),
       ('MAD', 504, 'Marokkói Dirham'),
       ('MDL', 498, 'Moldován Lei'),
       ('MGA', 969, 'Madagaszkári Ariary'),
       ('MKD', 807, 'Dénár'),
       ('MMK', 104, 'Kyat'),
       ('MNT', 496, 'Tugrik'),
       ('MOP', 446, 'Pataca'),
       ('MRU', 929, 'Ouguiya'),
       ('MUR', 480, 'Mauritius Rúpia'),
       ('MVR', 462, 'Rufiyaa'),
       ('MWK', 454, 'Kwacha'),
       ('MXN', 484, 'Mexikói Peso'),
       ('MXV', 979, 'Mexikói Unidad de Inversion (UDI)'),
       ('MYR', 458, 'Malajziai Ringgit'),
       ('MZN', 943, 'Mozambik Metical'),
       ('NAD', 516, 'Namíbiai Dollár'),
       ('NGN', 566, 'Naira'),
       ('NIO', 558, 'Cordoba Oro'),
       ('NOK', 578, 'Norvég Korona'),
       ('NPR', 524, 'Nepáli Rúpia'),
       ('NZD', 554, 'Új-Zéland Dollár'),
       ('OMR', 512, 'Rial Omán'),
       ('PAB', 590, 'Balboa'),
       ('PEN', 604, 'Nuevo Sol'),
       ('PGK', 598, 'Kina'),
       ('PHP', 608, 'Fülöp-szigeteki Peso'),
       ('PKR', 586, 'Pakisztán Rúpia'),
       ('PLN', 985, 'Zloty'),
       ('PYG', 600, 'Guarani'),
       ('QAR', 634, 'Katari Rial'),
       ('RON', 946, 'Román Lej'),
       ('RSD', 941, 'Szerb Dinár'),
       ('RUB', 643, 'Orosz Rubel'),
       ('RWF', 646, 'Ruandai Frank'),
       ('SAR', 682, 'Szaudi Riyal'),
       ('SBD', 90, 'Salamon-szigeteki Dollár'),
       ('SCR', 690, 'Seychelle-szigeteki rúpia'),
       ('SDG', 938, 'Szudáni Font'),
       ('SEK', 752, 'Svéd Korona'),
       ('SGD', 702, 'Szingapúri Dollár'),
       ('SHP', 654, 'Saint Hélen Font'),
       ('SLL', 694, 'Leone'),
       ('SOS', 706, 'Szomáliai Shilling'),
       ('SRD', 968, 'Surinam Dollár'),
       ('SSP', 728, 'Dél-szudáni font'),
       ('STN', 930, 'Dobra'),
       ('SVC', 222, 'El Salvador Colon'),
       ('SYP', 760, 'Szíriai Font'),
       ('SZL', 748, 'Lilangeni'),
       ('THB', 764, 'Baht'),
       ('TJS', 972, 'Somoni'),
       ('TMT', 934, 'Türkmenisztán New Manat'),
       ('TND', 788, 'Tunéziai Dinár'),
       ('TOP', 776, 'Pa’anga'),
       ('TRY', 949, 'Török Líra'),
       ('TTD', 780, 'Trinidad és Tobago Dollár'),
       ('TWD', 901, 'Új Tajvani Dollár'),
       ('TZS', 834, 'Tanzán Shilling'),
       ('UAH', 980, 'Hrivnya'),
       ('UGX', 800, 'Ugandai Shilling'),
       ('USD', 840, 'US Dollár'),
       ('USN', 997, 'US Dollár (Következő nap)'),
       ('UYI', 940, 'Uruguay Peso en Unidades Indexadas (URUIURUI)'),
       ('UYU', 858, 'Peso Uruguayo'),
       ('UZS', 860, 'Üzbegisztáni Sum'),
       ('VEF', 937, 'Bolivar'),
       ('VND', 704, 'Dong'),
       ('VUV', 548, 'Vatu'),
       ('WST', 882, 'Tala'),
       ('XAF', 950, 'CFA Frank BEAC'),
       ('XCD', 951, 'Kelet-karibi Dollár'),
       ('XDR', 960, 'SDR (Special Drawing Right)'),
       ('XOF', 952, 'CFA Frank BCEAO'),
       ('XPF', 953, 'CFP Frank'),
       ('XSU', 994, 'Sucre'),
       ('XUA', 965, 'ADB Elszámolási Egység'),
       ('YER', 886, 'Yemeni Rial'),
       ('ZAR', 710, 'Rand'),
       ('ZMW', 967, 'Zambiai Kwacha'),
       ('ZWL', 932, 'Zimbabwe Dollár');
...
CREATE INDEX idx_services_currency_code ON services (currency_code);
