...
use super::CustomersModuleInterface;
use super::handler;
...
pub fn routes<M: CustomersModuleInterface>(customers_module: Arc<M>) -> Router {
    Router::new().nest(
        "/customers",
        Router::new()
            ...
            .layer(from_fn_with_state(customers_module.clone(), require_auth))
