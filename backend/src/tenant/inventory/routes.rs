...
use super::InventoryModuleInterface;
use super::handler;
...
pub fn routes<M: InventoryModuleInterface>(inventory_module: Arc<M>) -> Router {
    Router::new().nest(
        "/inventory",
        Router::new()
            ...
            .layer(from_fn_with_state(inventory_module.clone(), require_auth))
