...
use super::ProductsModuleInterface;
use super::handler;
...
pub fn routes<M: ProductsModuleInterface>(products_module: Arc<M>) -> Router {
    Router::new().nest(
        "/products",
        Router::new()
            ...
            .layer(from_fn_with_state(products_module.clone(), require_auth))
