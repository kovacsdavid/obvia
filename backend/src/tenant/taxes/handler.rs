...
pub async fn get_resolved<M: TaxesModule>(
...
pub async fn get<M: TaxesModule>(
    AuthenticatedUser(claims): AuthenticatedUser,
    State(taxes_module): State<Arc<M>>,
    Query(payload): Query<UuidParam>,
) -> HandlerResult {
...
pub async fn create<M: TaxesModule>(
    AuthenticatedUser(claims): AuthenticatedUser,
    State(taxes_module): State<Arc<M>>,
...
pub async fn update<M: TaxesModule>(
    AuthenticatedUser(claims): AuthenticatedUser,
    State(taxes_module): State<Arc<M>>,
    UserInput(user_input, _): UserInput<TaxUserInput, TaxUserInputHelper>,
) -> HandlerResult {
...
pub async fn delete<M: TaxesModule>(
    AuthenticatedUser(claims): AuthenticatedUser,
    State(taxes_module): State<Arc<M>>,
    Query(payload): Query<UuidParam>,
) -> HandlerResult {
...
pub async fn list<M: TaxesModule>(
    AuthenticatedUser(claims): AuthenticatedUser,
    State(taxes_module): State<Arc<M>>,
...
pub async fn select_list<M: TaxesModule>(
    AuthenticatedUser(claims): AuthenticatedUser,
    State(taxes_module): State<Arc<M>>,
...
pub async fn print<M: TaxesModule>(
    AuthenticatedUser(claims): AuthenticatedUser,
    State(taxes_module): State<Arc<M>>,
    Query(payload): Query<UuidParam>,
) -> HandlerResult {
