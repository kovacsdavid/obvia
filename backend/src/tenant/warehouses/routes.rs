...
use super::WarehousesModuleInterface;
use super::handler;
...
pub fn routes<M: WarehousesModuleInterface>(warehouses_module: Arc<M>) -> Router {
    Router::new().nest(
        "/warehouses",
        Router::new()
            ...
            .layer(from_fn_with_state(warehouses_module.clone(), require_auth))
