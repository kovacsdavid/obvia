      ...
      >
        ...
        >
          ...
          <div className="flex items-start gap-3 mt-7 mb-5">
            <Checkbox
              id="self_hosted_db"
              checked={dbIsSelfHosted}
              onCheckedChange={setDbIsSelfHosted}
            />
            <Label htmlFor="self_hosted_db">
              Saját adatbázis kiszolgálót használok (haladó)
            </Label>
          </div>
          {dbIsSelfHosted === true && (
            <>
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  Felhívjuk figyelmét, hogy bár mindent elkövetünk a zavartalan
                  működés érdekében a saját üzemeltetésű adatbázisokért nem
                  tudunk semmilyen felelősséget vállalni! Az adatbázis
                  rendszeres biztonsági mentéséről, monitorozásáról és az összes
                  kapcsolódó karbantartáis feladatról a felhasználónak vagy az
                  általa megbízott szakembernek kell gondoskodnia! Ügyeljen
                  arra, hogy kifejezetten erre a célra létrehozott adatbázis
                  felhasználót adjon meg, mely csak a kifejezetten erre a célra
                  létrehozott üres adatbázis felett rendelkezik
                  jogosultságokkal!
                </AlertDescription>
              </Alert>
              <Alert variant="default">
                ...
                <AlertDescription>
                  Az adatbázisnak érvényes TLS tanusítvánnyal kell rendelkeznie
                  az adatátvitel biztonságának megőrzése érdekében!
                </AlertDescription>
              </Alert>
              <Alert variant="default">
                <Terminal />
                ...
                <AlertDescription>
                  Amennyiben a rendszer sikeresen csatlakozni tud a megadott
                  adatbázishoz az adatszerkezet kialakítását automatikusan
                  elvégzi.
                </AlertDescription>
              </Alert>
              <Alert variant="default">
                ...
                <AlertDescription>
                  Ha egy verziófrissítés az adatszerkezet módosítását teszi
                  szükségessé, akkor azt a rendszer automatikusan elvégzi.
                </AlertDescription>
              </Alert>
              ...
              <Alert variant="default">
                ...
                <AlertDescription>
                  Biztonsági okokból a rendszerhez hozzáadott adatbázis nevének
                  tartalmaznia kell a "tenant_" előtagot. Kérem, hogy az
                  adatbázist ennek megfelelően nevezze el!
                </AlertDescription>
              </Alert>
              <div className={"flex"}>
              ...
              <Alert variant="default">
                ...
                <AlertTitle>Előtag szükséges!</AlertTitle>
                <AlertDescription>
                  Biztonsági okokból a rendszerhez hozzáadott adatbázis
                  felhasználónak tartalmaznia kell a "tenant_" előtagot. Kérem,
                  hogy az adatbázis felhasznált ennek megfelelően nevezze el!
                </AlertDescription>
              </Alert>
              <div className={"flex"}>
                <div className="flex items-center justify-center px-3 border border-r-0 rounded-l bg-gray-50">
              ...
              <Alert variant="default">
                ...
                <AlertDescription>
                  Biztonsági okokból a jelszó 40-99 karakter hosszú lehet és az
                  angol abc kis és nagy betűit illetve számokat tartalmazhat{" "}
                  <br />
                  (Ezt a jelszót, amíg az adatbázis hozzá van rendelve a
                  rendszerhez nem kell újra megadni!)
                </AlertDescription>
              </Alert>
              <Input
                id="db_password"
