...
import { get_resolved } from "@/components/modules/projects/lib/slice.ts";
...
import type { ProjectResolved } from "@/components/modules/projects/lib/interface.ts";
import { useNavigate } from "react-router-dom";

export default function View() {
  const [data, setData] = React.useState<ProjectResolved | null>(null);
            ...
            <CardContent>
              <Table>
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell>Kezdődátum</TableCell>
                    <TableCell>
                      {formatDateToYMDHMS(data.start_date ?? "")}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Határidő</TableCell>
                    <TableCell>
                      {formatDateToYMDHMS(data.end_date ?? "")}
                    </TableCell>
                  </TableRow>
                  <TableRow>
