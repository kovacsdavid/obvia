            ...
            <Card>
                <CardHeader>
                    ...
                    <CardAction>
                        ...
                        <Link to={"/szolgaltatas/letrehozas"}>
                            <Button
                                style={{ color: "green" }}
                                variant="outline"
                            >
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>Alapértelmezett adózás</TableHead>
                                <TableHead>Alapértelmezett pénznem</TableHead>
                                <SortableTableHead
                                    field="status"
                                    orderBy={orderBy}
                                    order={order}
                                    ...
                                    <TableCell>
                                        <DropdownMenu>
                                            ...
                                            >
                                                ...
                                                <Link
                                                    to={`/szolgaltatas/reszletek/${item.id}`}
                                                >
                                                    <DropdownMenuItem>
                                                        <Eye /> Részletek
                                                    </DropdownMenuItem>
                                                ...
                                                <Link
                                                    to={`/szolgaltatas/modositas/${item.id}`}
                                                >
                                                    <DropdownMenuItem>
                                                        <Pencil /> Szerkesztés
                                                    </DropdownMenuItem>
