...
import { type ServiceResolved } from "@/components/modules/services/lib/interface.ts";
import {
  Table,
  TableBody,
  TableCell,
    ...
    <>
      ...
      {data !== null ? (
        <>
            ...
            <CardContent>
              <Table>
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell>Alapértelmezett ár</TableCell>
                    <TableCell>{data.default_price ?? "N/A"}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Alapértelmezett adózás</TableCell>
                    <TableCell>{data.default_tax ?? "N/A"}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Alapértelmezett pénznem</TableCell>
                    <TableCell>{data.currency_code ?? "N/A"}</TableCell>
                  </TableRow>
                  <TableRow>
          ...
          <ActivityFeed resourceId={data.id} resourceType="services" />
        </>
      ) : null}
    </>
  );
