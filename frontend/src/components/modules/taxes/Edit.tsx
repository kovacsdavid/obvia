                    ...
                    if (get.fulfilled.match(response)) {
                        if (response.payload.statusCode === 200) {
                            if (
                                ...
                                setIsRateApplicable(
                                    data.is_rate_applicable ? "true" : "false",
                                );
                    ...
                    <FieldSet>
                        ...
                        <FieldGroup>
                            ...
                            >
                                ...
                                <FieldError
                                    error={errors}
                                    field={"is_rate_applicable"}
                                />
                            </Field>
                            {isRateApplicable === "true" ? (
                                <>
                                    <Field
                                        data-invalid={isInvalidField("rate")}
                                    >
                            ...
                            <Field
                                data-invalid={isInvalidField("country_code")}
                            >
                            ...
                            <Field
                                data-invalid={isInvalidField("tax_category")}
                            >
                                <FieldLabel htmlFor="tax_category">
                                    Adó kategória
                                </FieldLabel>
                                <Select
                                    value={taxCategory}
                            ...
                            <Field
                                data-invalid={isInvalidField("reporting_code")}
                            >
                                <FieldLabel htmlFor="reporting_code">
                                    Jelentési kód
                                </FieldLabel>
                                <Input
                                    id="reporting_code"
