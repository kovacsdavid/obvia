...
import { deleteItem, list } from "@/components/modules/warehouses/lib/slice.ts";
...
export default function List() {
  ...
  return (
    <>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Raktárak</CardTitle>
        </CardHeader>
        <CardContent>
          <div className={"flex justify-between items-center mb-6"}>
            <div className="flex gap-2">
              <Link to={"/raktar/letrehozas"}>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Kapcsolattartó telefonszáma</TableHead>
            ...
            <TableBody>
              {data.map((item) => (
                <TableRow key={item.id}>
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent side={"bottom"} align="start">
                        ...
                        <Link to={`/raktar/modositas/${item.id}`}>
                          <DropdownMenuItem>
                            <Pencil /> Szerkesztés
                          </DropdownMenuItem>
                        </Link>
                  ...
                  <TableCell>
                    {item.contact_phone ? item.contact_phone : "N/A"}
                  </TableCell>
