...
import { get_resolved } from "@/components/modules/warehouses/lib/slice.ts";
import {
  Table,
  TableBody,
  TableCell,
    ...
    <>
      ...
      {data !== null ? (
        <>
              ...
              <Table>
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>{data.contact_name ?? "N/A"}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Kapcsolattartó telefonszáma</TableCell>
                    <TableCell>{data.contact_phone ?? "N/A"}</TableCell>
                  </TableRow>
                  <TableRow>
          ...
          <ActivityFeed resourceId={data.id} resourceType="warehouses" />
        </>
      ) : null}
    </>
  );
