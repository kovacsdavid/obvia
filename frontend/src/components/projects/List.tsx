...
import {deleteItem, list} from "@/components/projects/slice.ts";
import {type SimpleError} from "@/lib/interfaces/common.ts";
import {type ProjectResolvedList} from "@/components/projects/interface.ts";
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent side={"bottom"} align="start">
                        ...
                        <Link to={`/projekt/reszletek/${item.id}`}>
                          <DropdownMenuItem>
                            <Eye/> Részletek
                          </DropdownMenuItem>
                        </Link>
