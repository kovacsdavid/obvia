...
import {deleteItem, list} from "@/components/taxes/slice.ts";
import {type SimpleError} from "@/lib/interfaces/common.ts";
import {type TaxResolvedList} from "@/components/taxes/interface.ts";
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent side={"bottom"} align="start">
                        ...
                        <Link to={`/ado/reszletek/${item.id}`}>
                          <DropdownMenuItem>
                            <Eye/> Részletek
                          </DropdownMenuItem>
                        </Link>
                        <Link to={`/ado/szerkesztes/${item.id}`}>
                          <DropdownMenuItem>
                            <Pencil/> Szerkesztés
                          </DropdownMenuItem>
                        </Link>
