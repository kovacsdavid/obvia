...
describe("extract_field", () => {
    it("should extract ordering", () => {
        const input =
            "ordering:test-asc paging:1-25 filtering:test-|warehouse 1|";
...
describe("formatNumber", () => {
    ...
    describe("Thousand separators", () => {
        ...
        it("should not add thousand separators when disabled", () => {
            expect(
                formatNumber(1234567, { showThousandSeparator: false }),
            ).toBe("1234567");
        });
    });
    ...
    describe("Decimal places", () => {
        it("should format decimal numbers with specified decimal places", () => {
            expect(formatNumber(1234.5678, { decimalPlaces: 2 })).toBe(
                "1 234,57",
            );
    ...
    describe("Edge cases", () => {
        ...
        it("should handle very small decimals", () => {
            expect(formatNumber(0.000001, { decimalPlaces: 6 })).toBe(
                "0,000001",
            );
        });
